...
Eigen::Vector3d transformPoint(const Eigen::Vector3d & point, const geometry_msgs::Pose & pose)
{
  geometry_msgs::Transform transform;
  transform.translation.x = pose.position.x;
  transform.translation.y = pose.position.y;
  ...
  const geometry_msgs::Point32 & point32, const geometry_msgs::Pose & pose)
{
  ...
  geometry_msgs::Point32 result_point;
  result_point.x = transformed_point.x;
  result_point.y = transformed_point.y;
  result_point.z = transformed_point.z;
  return result_point;
